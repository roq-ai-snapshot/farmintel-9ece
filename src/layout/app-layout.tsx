...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Farm', path: '/farms', entity: 'farm', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
  { name: 'Livestock', path: '/livestocks', entity: 'livestock', service: AccessServiceEnum.PROJECT, icon: FiFeather },
